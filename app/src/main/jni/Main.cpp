...
Java_uk_lgl_modmenu_FloatingModMenuService_getFeatureList(JNIEnv *env, jobject context) {
    ...
    MakeToast(env, context, OBFUSCATE("Modded by Đức Anh"), Toast::LENGTH_LONG);
    ...
    const char *features[] = {
          ...
          //  OBFUSCATE("CollapseAdd_SeekBar_The slider_1_100"),
            ...
            OBFUSCATE("Collapse_Contact Me On"),
            OBFUSCATE("CollapseAdd_ButtonLink_Github_https://github.com/ducnh1290"),
            OBFUSCATE("CollapseAdd_ButtonLink_Facebook_https://fb.com/ducanhle1290"),
            OBFUSCATE("CollapseAdd_ButtonLink_Mail_mailto:leducanh1290@gmail.com"),
            OBFUSCATE("CollapseAdd_ButtonLink_Zalo_https://www.youtube.com/"),
            OBFUSCATE("RichTextView_<b><font color='red'>LƯU Ý : </font></b></font></b>Khi dùng bản mod này nghĩa là bạn đã chấp nhận với việc acc có thể bị <b><u><font color='red'>khoá.</font></u></b>"
                      "Vì mình đã trực tiếp can thiệp vào data game.Nên nếu có bị khoá acc bạn cũng đừng ngạc nhiên nhé."
                      "<br />Chúc bạn may sử dụng bản mod vui vẻ !"),
